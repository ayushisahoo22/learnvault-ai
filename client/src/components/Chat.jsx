    ...
    return(
        <>
            <div className={`flex-1 flex flex-col ${darkMode?"bg-slate-950":"bg-gray-100"} transition-all duration-300 p-6 h-full overflow-hidden`}>
                <Panel setIsNewChat={setIsNewChat} setInput={setInput} setCurrentConversationId={setCurrentConversationId} setDarkMode={setDarkMode} darkMode={darkMode} topics={topics} search={search} setSearch={setSearch}
